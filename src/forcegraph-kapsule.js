...
import {l} from "./utils/utilllllllll.js";

//
l("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab")
...
export default Kapsule({
        ...
        methods: {
            ...
            tickFrame: function (state) {
                ...
                l("isd3sim111111", state.forceEngine !== 'ngraph')
                ...
                function layoutTick() {
                    ...
                    state.graphData.nodes.forEach(node => {
                        ...
                        if (!state.nodePositionUpdate
                            || !state.nodePositionUpdate(extendedObj ? obj.children[0] : obj, {
                                x: pos.x,
                                y: pos.y,
                                z: pos.z
